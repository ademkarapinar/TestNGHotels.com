...
public class FourStarHotelPage extends BasePage {
	WebDriver driver;
	ElementUtil elementUtil;
	JavaScriptUtil javascriptUtil;
	double requestedMile =10;
	
	By fourStar = By.xpath("//*[@id='f-star-rating-4']");
	...
	public FourStarHotelPage(WebDriver driver){
		this.driver = driver;
		elementUtil = new ElementUtil(driver);
		javascriptUtil = new JavaScriptUtil(driver);

   }
	public void get4StarHotels() throws InterruptedException{
